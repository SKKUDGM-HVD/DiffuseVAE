...
from models.diffusion import DDPM, DDPMv2, DDPMWrapper, E2EDDPMWrapper, SuperResModel, UNetModel
from models.diffusion.end_to_end_wrapper_stage3 import E2EDDPMWrapper_stage3
...
def train(config):
    ...
    ddpm_wrapper = E2EDDPMWrapper_stage3(
        online_ddpm,
        target_ddpm,
        vae,
        lr=lr,
