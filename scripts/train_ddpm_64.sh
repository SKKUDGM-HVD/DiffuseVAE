...
# # CelebA-64 (Form-1)
 python main/train_ddpm.py +dataset=celeba64/train \
                      ...
                      dataset.ddpm.training.device=\'gpu:0\' \
                      dataset.ddpm.training.results_dir=\'/root/workspace/skku/DGM/DiffuseVAE/diffusevae_celeba64_rework_form1__21stJune_sota_nheads=8_dropout=0.1/\' \
                      dataset.ddpm.training.workers=1 \
...
#                      dataset.ddpm.training.batch_size=8 \
                      #dataset.ddpm.training.vae_chkpt_path=\'/root/workspace/skku/DGM/DiffuseVAE/result/vae_cmhq128_alpha=1.0/checkpoints/test.ckpt\' \
#                      dataset.ddpm.training.device=\'gpu:0,1,2\' \
                      #dataset.ddpm.training.results_dir=\'/root/workspace/skku/DGM/DiffuseVAE/diffusevae_celebahq128_rework_form1__21stJune_sota_nheads=8_dropout=0.1/\' \
 #                     dataset.ddpm.training.workers=1 \
