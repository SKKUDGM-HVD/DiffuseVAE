python main/eval/ddpm/generate_recons.py +dataset=celeba64/test \
                         ...
                         dataset.ddpm.evaluation.chkpt_path=\'/root/workspace/skku/DGM/DiffuseVAE/diffusevae_celeba64_rework_form1__21stJune_sota_nheads=8_dropout=0.1/checkpoints/ddpmv2.ckpt\' \
                         ...
                         dataset.ddpm.evaluation.save_path=\'/root/workspace/skku/DGM/DiffuseVAE/ddpm_result_64/\' \
